...
const HeroSection = () => {
  ...
  return (
    <section
      ref={heroRef}
      className="w-full flex lg:flex-row flex-col justify-between items-center gap-5 lg:h-[90vh] pt-16 mt-[10%] my-[5%] px-7 lg:px-[8%] overflow-hidden"
    >
      <div className="max-w-[1440px] flex justify-between items-center">
        ...
        >
          <h1 className="lg:text-6xl text-4xl pt-3 font-medium transition-transform duration-1000 hover:scale-105">
          ...
          <p className="text-primary max-w-md md:text-lg text-lg font-normal">
